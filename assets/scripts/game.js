...
const answerSlot1 = $(`#slot1`);
const answerSlot2 = $(`#slot2`);
const answerSlot3 = $(`#slot3`);
const answerSlot4 = $(`#slot4`);
...
let triviaGame = {
    ...
    serveQuestion: function(){
        ...
        let correctAnswerSlot = Math.floor(Math.random() * 3 + 1);
        console.log(correctAnswerSlot);
        // use correctAnswerSlow to place correct answer randomly

        // loop through question slots, test is text is blank place wrong answers only in blank slots
    },
